...
module.exports = class Engine {
  ...
  async tickReport () {
    if (this.assetBalance && this.assetBalanceStart) {
      log.info(
        `${fk(this.asset, this.assetBalanceStart.total)}`.yellow, `/`, `${fk(this.asset, this.assetBalance.total)}`.cyan,
        `|`, `${fk(this.currency, this.currencyBalanceStart.total)}`.yellow, `/`, `${fk(this.currency, this.currencyBalance.total)}`.cyan,
