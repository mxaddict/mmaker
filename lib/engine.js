  ...
  async tickInfo () {
    try {
      ...
      if (!this.started && this.bid) {
        ...
        if (this.argv.reset_profit || !balanceCache[this.asset] || !balanceCache[this.currency]) {
          // Save the balances
    ...
    try {
      ...
      if (this.started) {
        log.info(
          ...
          'p', fpl(this.currency, this.currencyBalanceConsolidatedBase - this.currencyBalanceConsolidatedStart),
