...
module.exports = class Engine {
  constructor (argv) {
    ...
    this.pollPrice = this.conf.pollPrice || 2500           // How often do poll for price changes
    this.pollOrders = this.conf.pollOrders || 2500         // How often do poll for order changes
    ...
    this.pollTrades = this.conf.pollTrades || 10000        // How often do poll for trade changes
    this.pollBalance = this.conf.pollBalance || 5000       // How often do poll for balance changes
  ...
  async tickOrdersBuy () {
    try {
      if (this.started) {
        ...
        if (this.orders.length !== this.maxBullets * 2) {
