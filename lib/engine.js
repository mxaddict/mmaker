...
module.exports = class Engine {
  constructor (argv) {
    ...
    this.pollOrdersBuy = this.conf.pollOrdersBuy || 500    // How often do poll for order changes
    this.pollOrdersSell = this.conf.pollOrdersSell || 500  // How often do poll for order changes
