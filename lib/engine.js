...
module.exports = class Engine {
  constructor (argv) {
    ...
    this.pollOrders = this.conf.pollOrders || 250    // How often do poll for order changes
    this.pollTrades = this.conf.pollTrades || 250    // How often do poll for trade changes
    ...
    // Get order settings
    this.minWidthPercent = this.conf.minWidthPercent || 0.5
