...
module.exports = class Engine {
  constructor (argv) {
    ...
    this.pollOrdersBuy = this.conf.pollOrdersBuy || 10000   // How often do poll for order changes
    this.pollOrdersSell = this.conf.pollOrdersSell || 10000 // How often do poll for order changes
    ...
    this.pollReport = this.conf.pollReport || 15000         // How often do poll for report changes

    // Get order settings
    this.minWidthPercent = (this.conf.minWidthPercent || 0.5) / 100
    this.minWidthPercentIncrement = (this.conf.minWidthPercentIncrement || 0.25) / 100
